...
grep -Eq 'Patch generated Emscripten HTML bootstrap' "$workflow"
grep -Eq 'script async type="text\\/javascript" src="app\\.js"' "$workflow"
grep -Eq 'script async type="text\\/javascript" src="index\\.js"' "$workflow"
